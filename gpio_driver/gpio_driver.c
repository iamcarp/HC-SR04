...
MODULE_AUTHOR("Luka Karan, Laza Jakovljevic");
...
//vrednost se menja izmedju funkcija,hardverski
volatile static ktime_t echo_start;
volatile static ktime_t echo_end;
volatile static int vreme;
volatile static int uspesno;

char* gpio_driver_buffer;

/* vizualno mapiranje GPIO */
void* virt_gpio_base;
...

//prekid za falling edge,eho na 0
static irqreturn_t h_irq_echo(int irq, void *data)
{
	echo_end = ktime_get();
//vreme= kraj-pocetak
	vreme = (int)ktime_to_us(ktime_sub(echo_end,echo_start));
	uspesno = 1;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	result = gpio_request_one(GPIO_ECHO, GPIOF_IN, "irq_echo");
	if(result != 0)
    {
        printk("Error: GPIO request failed!\n");
        goto fail_irq;
    }
    irq_echo = gpio_to_irq(GPIO_ECHO);
	result = request_irq(irq_echo, h_irq_echo,
      IRQF_TRIGGER_FALLING, "irq_echo", (void *)(h_irq_echo));
	if(result != 0)
    {
...
void gpio_driver_exit(void)
{
	...
	disable_irq(irq_echo);
    free_irq(irq_echo, h_irq_echo);
    gpio_free(GPIO_ECHO);
...
//eho ode na 1,da->meri vreme,ne break
	while (1)
	{
...
//meri vreme
	...
	sprintf(gpio_driver_buffer, "%d", vreme);

    if (*f_pos == 0)
    {
